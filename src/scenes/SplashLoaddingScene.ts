...
export class SplashLoaddingScene extends Scene{
    ...
    preload(): void {
        ...
        this.loadingText = TextAdapter.instance.getVectorText(this,'FC_Lamoon_Bold')
                                                .setText('โหลด Asset')
                                                .setPosition(this.cameras.main.centerX ,
        ...
        .loadPackJson('townload', `assets/town/townload.json`)
        .subscribe(() => {
